...
public class ApiTrainingsApplication implements CommandLineRunner{
	...
	trainingRepository.save(new Training(null, "DotNet","DotNet & entity framework en 5 jours", 2750.0, 1));
	trainingRepository.save(new Training(null, "PowerBi","Business Intelligence en 5 jours", 3000.0, 1));
	trainingRepository.save(new Training(null, "NodeJs","Prise en main de NodeJs/Express 2 jours", 3500.0, 1));
